...
Boxscores and Play by Play will be extracted from raw game data. So we have to load the raw game data first. The game ids are included in `games`. In this example these are `r `cli::cli_text("{games$id}")`. 
